...
--
-- Name: movie_cast_id; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- Name: moviescast id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
SELECT pg_catalog.setval('public.movie_cast_id_seq', 5, true);
