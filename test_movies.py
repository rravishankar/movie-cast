...
# Test for movies
    ...
    def test_get_paginated_movies(self):
        ...
        # page_num = 1
        # while 1:
        #     resp = self.client().get('/movies?page=' \
        # +str(page_num), headers=auth_header)
        #     data = json.loads(resp.data)
    ...
    def test_add_movie(self):
        ...
        resp = self.client().post(
            '/movies',
            data='{"title": "Geography","release_date":"2010/02/16"}',
            content_type='application/json',
            headers=auth_header)
        print(
            "test_add_movie: Got response:{} {}".format(
                resp.data, type(
                    resp.data)))
        data = json.loads(resp.data)
        self.assertEqual(resp.status_code, 200)
    ...
    def test_delete_movie(self):
        ...
        resp = self.client().delete('/movies/' + str(movie_id),
                                    headers=auth_header)
        data = json.loads(resp.data)
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(data['success'], True)
    ...
    def test_404_update_movie_not_existing(self):
        ...
        print("test_404_update_movie_not_existing: \
            Got inserted & deleted movie id: {}".format(
            inserted_movie_id))
        resp = self.client().patch(
            '/movies/' + str(inserted_movie_id),
            data='{"title":"History"}',
...
# Test for actors/artist
    ...
    def test_404_get_request_beyond_validate_page_actors(self):
        ...
        data = json.loads(resp.data)
        print("test_404_get_request_beyond_validate_page_actors:Got \
            data", data)
    ...
    def test_add_actor(self):
        ...
        resp = self.client().post(
            ...
            headers=auth_header)
        print(
            "test_add_actor: Got response:{} {}".format(
                resp.data, type(
                    resp.data)))
        data = json.loads(resp.data)
        self.assertEqual(resp.status_code, 200)
    ...
    def test_delete_actor(self):
        ...
        resp = self.client().delete('/actors/' + str(actor_id),
                                    headers=auth_header)
        data = json.loads(resp.data)
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(data['success'], True)
    ...
    def test_update_actor(self):
        global inserted_actor_id
        self.test_add_actor()
        print("test_update_actor: Got inserted actor \
            id: {}".format(inserted_actor_id))
        resp = self.client().patch(
            '/actors/' + str(inserted_actor_id),
            data='{"name":"God"}',
            content_type='application/json',
            headers=auth_header)
        data = json.loads(resp.data)
    ...
    def test_404_update_actor_not_existing(self):
        global inserted_actor_id
        self.test_add_actor()
        print("test_404_update_actor_not_existing: Got inserted \
            actor id: {}".format(
            inserted_actor_id))
    ...
    def test_add_moviecast(self, auth_header_farg=None):
        ...
        print("test_add_movie: Got \
            actor_details_dict:", moviecast_details_dict)
    ...
    def test_delete_moviecast(self):
        ...
        resp = self.client().delete(
            ...
            headers=auth_header)
        print(
            "test_delete_moviecast: Got response:{} {}".format(
                resp.data, type(
                    resp.data)))
        data = json.loads(resp.data)
        self.assertEqual(resp.status_code, 200)
    ...
    def test_404_delete_if_moviecast_does_not_exist(self):
        print(
            "test_404_delete_if_moviecast_does_not_exist: \
                Deleting actor id: {} movie_id: {}".format(
                0,
                0))
        resp = self.client().delete(
            '/moviecast',
    ...
    def test_role_casting_assistant_not_allowed_add_moviecast(self):
        ...
        print(
            "test_role_casting_assistant_not_allowed_add_moviecast: \
                Got inserted actor id: {} movie_id: {}".format(
                inserted_actor_id,
                inserted_movie_id))
        resp = self.client().post(
            '/moviecast',
        ...
        print(
            "test_role_casting_assistant_not_allowed_add_moviecast: \
                ...
                type(
                    resp.data)))
        data = json.loads(resp.data)
        print("test_role_casting_assistant_not_allowed_add_moviecast:\
            Got data", data)
    ...
    def test_role_casting_dir_not_allowed_add_moviecast(self):
        ...
        print(
            "test_role_casting_dir_not_allowed_add_moviecast: Got inserted \
        ...
        resp = self.client().post(
            ...
            headers=auth_header_ca)
        print(
            "test_role_casting_dir_not_allowed_add_moviecast: \
                Got response:{} {}".format(
                resp.data,
                type(
                    resp.data)))
    ...
    def test_role_exec_prod_allowed_to_add_movie(self):
        ...
        print(
            "test_role_exec_prod_allowed_to_add_movie: \
                Got response:{} {}".format(
                resp.data, type(
                    resp.data)))
        data = json.loads(resp.data)
    ...
    def test_get_paginated_moviecast(self):
        ...
        #     if data['success'] == False:
        #         break
        #     print("Moviecast data (page {}):{}".format(page_num,data\
        # ['movie_actor_list']))
        #     page_num += 1
    ...
    def test_404_get_request_beyond_validate_page_moviecast(self):
        ...
        data = json.loads(resp.data)
        print("test_404_get_request_beyond_validate_page_moviecast:Got \
            data", data)
