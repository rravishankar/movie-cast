...
#Test for movies
    ...
    def test_add_movie(self):
        ...
        resp = requests.post(url + '/movies', data='{"title": "Heroku Geography Super","release_date":"2010/02/16"}', headers=new_header)
        data = resp.json()
    ...
    def test_400_error_add_movie_without_details(self):
        ...
        resp = requests.post(url +'/movies', data='{"release_date":"2010/02/16"}', headers=new_header)
        data = resp.json()
        print("test_400_error_add_movie_without_details: Got response:{}".format(data))
    ...
    def test_delete_movie(self):
        ...
        new_header = auth_header.copy() #Not needed, as this doesn't have data
        resp = requests.delete(url + '/movies/' + str(movie_id), headers=new_header)
        data = resp.json()
    ...
    def test_404_delete_if_movie_does_not_exist(self):
        ...
        deleted_movie_id = inserted_movie_id #This will be the delete movie ID
        resp = requests.delete(url + '/movies/' + str(deleted_movie_id), headers=new_header)
        data = resp.json()
    ...
    def test_update_movie(self):
        ...
        resp = requests.patch(url + '/movies/' + str(inserted_movie_id), data='{"title":"History"}', headers=new_header)
        data = resp.json()
...
# #Test for actors/artist
    ...
    def test_add_actor(self):
        ...
        resp = requests.post(url + '/actors', data='{"name":"Dorumcorum","age":"33", "gender": "Male"}', headers=new_header)
        data = resp.json()
    ...
    def test_400_error_add_actor_without_details(self):
        ...
        resp = requests.post(url + '/actors', data='{"name":"Incompo","gender": "Male"}', headers=new_header)
        data = resp.json()
    ...
    def test_delete_actor(self):
        ...
        resp = requests.delete(url +'/actors/' + str(actor_id), headers=auth_header)
        data = resp.json()
    ...
    def test_404_delete_if_actor_does_not_exist(self):
        ...
        resp = requests.delete(url + '/actors/' + str(deleted_actor_id), headers=auth_header)
        data = resp.json()
    ...
    def test_update_actor(self):
        ...
        resp = requests.patch(url + '/actors/' + str(inserted_actor_id), data='{"name":"God"}', headers=new_header)
        data = resp.json()
    ...
    def test_404_update_actor_not_existing(self):
        ...
        resp = requests.patch(url + '/actors/' + str(inserted_actor_id), data='{"title":"History Civics"}', headers=new_header)
        data = resp.json()
    ...
    def test_add_moviecast(self, auth_header_farg=None):
        ...
        resp = requests.post(url + '/moviecast', data='{"actor_id":' + str(inserted_actor_id) + ',' + '"movie_id":' + str(inserted_movie_id) +  '}', headers=new_header)
        data = resp.json()
    ...
    def test_400_error_add_moviecast_without_details(self):
        ...
        print("test_400_error_add_moviecast_without_details: Got inserted actor id: {} ".format(inserted_actor_id))
        resp = requests.post(url + '/moviecast', data='{"actor_id":' + str(inserted_actor_id) +  '}', headers=new_header)
        data = resp.json()
        print("test_400_error_add_moviecast_without_details: Got response:{}".format(data))
    ...
    def test_delete_moviecast(self):
        ...
        new_header = auth_header.copy()
        new_header["Content-type"] = "application/json"
        resp = requests.delete(url + '/moviecast', data='{"actor_id":' + str(inserted_actor_id) + ',' + '"movie_id":' + str(inserted_movie_id) +  '}', headers=new_header)
        data = resp.json()
    ...
    def test_404_delete_if_moviecast_does_not_exist(self):
        ...
        new_header = auth_header.copy()
        new_header["Content-type"] = "application/json"
        resp = requests.delete(url + '/moviecast', data='{"actor_id":' + str(0) + ',' + '"movie_id":' + str(0) +  '}', headers=new_header)
        data = resp.json()

        print("test_404_delete_if_moviecast_does_not_exist: Got response", data)
    ...
    def test_role_casting_assistant_not_allowed_add_moviecast(self):
        ...
        data = resp.json()
        print("test_role_casting_assistant_not_allowed_add_moviecast:Got response", data)
    ...
    def test_role_casting_assistant_allowed_to_get_actors(self):
        ...
        # resp = self.client().get('/actors', headers=auth_header)
        data = resp.json()
        print("test_role_casting_assistant_allowed_to_get_actors: Got response", data)
    ...
    def test_role_casting_dir_not_allowed_add_moviecast(self):
        ...
        resp = requests.post(url + '/moviecast', data='{"actor_id":' + str(inserted_actor_id) + ',' + '"movie_id":' + str(inserted_movie_id) +  '}', headers=auth_header_ca)
        data = resp.json()
    ...
    def test_role_casting_dir_allowed_to_get_actors(self):
        ...
        # resp = self.client().get('/actors', headers=auth_header)
        data = resp.json()
        print("test_role_casting_dir_allowed_to_get_actors: Got response", data)
    ...
    def test_role_exec_prod_allowed_to_add_movie(self):
        ...
        resp = requests.post(url + '/movies', data='{"title": "Geography","release_date":"2010/02/16"}', headers=auth_header_ca)
        data = resp.json()

        print("test_role_exec_prod_allowed_to_add_movie: Got response:{}".format(data))
        data = resp.json()
        self.assertEqual(resp.status_code, 200)
        self.assertEqual(data['success'], True)
        movie_details_dict = data['movies'][0]
